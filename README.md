![Ship](https://raw.githubusercontent.com/paralect/ship/master/ship.png)
...
|:---|:----------|:------|
|[Next.JS landing](https://github.com/paralect/nextjs-landing-starter)|Landing site|[2.1.0](https://github.com/paralect/nextjs-landing-starter/releases/tag/2.1.0)|
|[Koa.JS REST api](https://github.com/paralect/koa-api-starter)|REST api|[1.6.1](https://github.com/paralect/koa-api-starter/releases/tag/1.6.1)|
|[React.JS(with Redux) web app](https://github.com/paralect/koa-react-starter)|React.JS application|[1.1.1](https://github.com/paralect/koa-react-starter/releases/tag/2.1.1)|
...
|[Deploy Grafana](https://github.com/paralect/deploy-grafana)|Ansible automation for production-ready Grafana deployment|[1.0.0](https://github.com/paralect/deploy-grafana/releases/tag/1.0.0)|
